...
using UnityEngine;
    ...
    public class ItemRoot : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            GameObject[] respawn1 = GameObject.FindGameObjectsWithTag("Crab");
            //GameObject[] respawn2 = GmaeObject.FindGameObjectsWithTag("Corn");
            ...
            foreach (GameObject co in respawn1)
            {
                MeshRenderer renderer = co.GetComponentInChildren<MeshRenderer>();
                if (renderer != null)
                {
                    renderer.enabled = false;
                }
                this.respawn_points.Add(co.transform.position);
            }
            */
        }
